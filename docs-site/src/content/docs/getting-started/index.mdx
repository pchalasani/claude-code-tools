...
| [`agent-tunnel`](/claude-code-tools/tools/agent-tunnel/) | Share a live Claude Code session with teammates over Discord or Mattermost (`>share`) |
| [`github-wake`](/claude-code-tools/tools/github-wake/) | Wake the current session when an existing GitHub issue gets a reply |
